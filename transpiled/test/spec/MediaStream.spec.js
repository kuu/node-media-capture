...
var _srcMediaStream = require('../../src/MediaStream');

var _srcMediaStream2 = _interopRequireDefault(_srcMediaStream);
...
describe('MediaStream', function () {
  ...
  it('has readonly members', function () {
    var stream = new _srcMediaStream2['default']();
  ...
  it('can be created from an array of MediaStreamTrack objects', function () {
    var track1 = undefined,
        track2 = undefined,
        stream = undefined;
    track1 = new _srcMediaStreamTrack2['default']('video', 'Internal Camera');
    track2 = new _srcMediaStreamTrack2['default']('audio', 'Built-in microphone');
    stream = new _srcMediaStream2['default']([track1, track2]);
  ...
  it('can be created from an existing MediaStream object', function () {
    ...
    stream1 = new _srcMediaStream2['default']([track1, track2]);
    stream2 = new _srcMediaStream2['default'](stream1);
  ...
  it('is said to be active when it has at least one MediaStreamTrack that has not ended', function () {
    ...
    track1 = new _srcMediaStreamTrack2['default']('video', 'Internal Camera');
    track2 = new _srcMediaStreamTrack2['default']('audio', 'Built-in microphone');
    stream1 = new _srcMediaStream2['default']();
    ...
    stream2 = new _srcMediaStream2['default']([track1, track2]);
  ...
  it('fires an active/inactive event when its active status changes', function () {
    ...
    track1 = new _srcMediaStreamTrack2['default']('video', 'Internal Camera');
    track2 = new _srcMediaStreamTrack2['default']('audio', 'Built-in microphone');
    stream = new _srcMediaStream2['default']();
  ...
  describe('addTrack', function () {
    ...
    it('fires an addtrack event when a new MediaStreamTrack has been added to the stream', function () {
      ...
      track1 = new _srcMediaStreamTrack2['default']('video', 'Internal Camera');
      track2 = new _srcMediaStreamTrack2['default']('audio', 'Built-in microphone');
      stream = new _srcMediaStream2['default']([track1]);
